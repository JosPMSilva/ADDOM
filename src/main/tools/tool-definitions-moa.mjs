        ...
        tasks: {
          ...
          items: {
            ...
            properties: {
              ...
              instruction: { type: 'string', minLength: 1, description: 'Specific bounded assignment.' },
              context: { type: 'string', minLength: 1, description: 'Concise self-sufficient context or exact snippets.' },
              paths: {
                type: 'array',
                minItems: 1,
