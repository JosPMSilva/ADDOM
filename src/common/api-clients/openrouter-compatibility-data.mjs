export const OPENROUTER_COMPATIBILITY_ENTRIES = Object.freeze([
  ...
  { sourceProviderId: 'gemini', sourceModelId: 'gemini-3.8-flash', routeId: 'google/gemini-3.8-flash', status: 'direct', notes: 'Provider namespace changes.' },
  ...
  { sourceProviderId: 'gemini', sourceModelId: 'gemini-3.5-flash-lite', routeId: 'google/gemini-3.5-flash-lite', status: 'direct', notes: 'Provider namespace changes.' },
  ...
  { sourceProviderId: 'moonshot', sourceModelId: 'kimi-k3', routeId: 'moonshotai/kimi-k3', status: 'direct', notes: '' },
  ...
  { sourceProviderId: 'grok', sourceModelId: 'grok-4.6', routeId: 'x-ai/grok-4.6', status: 'direct', notes: 'Provider namespace changes.' },
  ...
  { sourceProviderId: 'groq', sourceModelId: 'groq/compound-mini', routeId: '', status: 'unsupported', notes: 'No exact OpenRouter route found on 2026-09-16.' },
  ...
  { sourceProviderId: 'deepseek', sourceModelId: 'deepseek-flash', routeId: 'deepseek/deepseek-v4.1-flash', status: 'remap', notes: 'OpenRouter uses the marketed version name.' },
